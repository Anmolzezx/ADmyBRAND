          ...
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl border border-[#E0E0E0] p-8 md:p-14 flex flex-col gap-8 mt-24">
              ...
              >
                <span className="flex items-center justify-center gap-3">
                  <img
                    ...
                    width={48}
                    height={48}
                    style={{ display: "inline", verticalAlign: "middle", filter: "invert(41%) sepia(97%) saturate(7496%) hue-rotate(10deg) brightness(101%) contrast(101%)" }}
                  />
                ...
                <span className="flex items-center justify-center gap-3 mt-2">
                  <img
                    ...
                    width={40}
                    height={40}
                    style={{ display: "inline", verticalAlign: "middle", filter: "invert(54%) sepia(92%) saturate(7496%) hue-rotate(10deg) brightness(101%) contrast(101%)" }}
                  />
                  <span className="inline-block align-middle">
                    that <span style={{ color: "#f4791f" }}>Grows</span> with You
                  </span>
                </span>
              </h1>
            </MotionDiv>
              ...
              <div className="flex justify-center">
                <div className="relative inline-block group">
                  ...
                  <div
                    ...
                    style={{
                      background: "radial-gradient(circle at 60% 40%, #f4791f33 0%, #eaf4f4 60%, #fff5ec 100%)",
                      zIndex: 0,
                      filter: "blur(12px)",
                      opacity: 0.8,
                    }}
            ...
            <MotionDiv delay={0.4}>
              <div className="mt-4 flex flex-col sm:flex-row justify-center gap-4 items-center">
                ...
                >
                  <a href="#pricing" className="flex items-center gap-3 relative z-10">
                ...
                >
                  <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                    <span className="relative inline-flex items-center justify-center">
                      <span className="absolute animate-ping inline-flex h-full w-full rounded-full bg-[#f4791f]/30 opacity-75"></span>
                      <span className="inline-flex items-center justify-center bg-white rounded-full p-2 mr-1 border border-[#eaf4f4] shadow"
